...
export default function ExternalFooter() {
    return (
        <Box
            ...
            pb={10}
        >
            <Container as={Stack} maxW="7xl" py={10} px={12}>
                <SimpleGrid
                ...
                >
                    <Stack spacing={6}>
                        ...
                        <Text fontSize={"sm"}>
                            © {new Date().getFullYear()} Tech Savvy Youth.
                            <br />
                            501(C)3 Non-profit (EIN: 85-4090345).
                            <br />
                            Founded by{" "}
                            <Link
                                color="brand.500"
                        ...
                        <Stack direction={"row"} spacing={6}>
                            ...
                            <SocialButton
                                label="Linkedin"
                                href={
                                    "https://www.linkedin.com/company/tech-savvy-youth"
                                }
                            >
                                <FaLinkedin size="1.2rem" />
                            </SocialButton>
                            <SocialButton label="PayPal" href={"/donate"}>
                                <FaPaypal size="1.2rem" />
                            </SocialButton>
                        </Stack>
                    </Stack>
